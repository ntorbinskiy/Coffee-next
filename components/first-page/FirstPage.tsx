...
import coff1 from "../../public/img/main/COFF1.png";
import coff2 from "../../public/img/main/COFF2.png";
import coff3 from "../../public/img/main/COFF3.png";
        ...
        <section className="header">
          <div className="container ">
            ...
            <div className="header_Middle">
              ...
              <button className="header_Make_btn" type="button">
                More
              </button>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className="Ourbest_div">
              <div className="Ourbest_div_item">
                ...
                <div className="Ourbest_div_item_subtitle">
              ...
              <div className="Ourbest_div_item">
                ...
                <div className="Ourbest_div_item_subtitle Ourbest_div_item_subtitle_th">
